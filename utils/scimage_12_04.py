...
CLOUDERA_APT = '[arch=amd64] http://archive.cloudera.com/cdh4/ubuntu/precise/amd64/cdh precise-cdh4 contrib'
...
def install_hadoop():
    ...
    hadoop_pkgs = ['namenode', 'datanode', 'tasktracker', 'jobtracker',
                   'secondarynamenode']
    pkgs = ['hadoop-0.20-mapreduce-jobtracker', 'hadoop-hdfs-namenode', 'hadoop-hdfs-secondarynamenode' , 'hadoop-0.20-mapreduce-tasktracker','hadoop-hdfs-datanode','hadoop-client']
